# Establishing Technical Charter

> Defining and fostering a culture that supports effective delivery. This
...
Standups can easily drift into long discussions, frustrating people who just
want to get on with their work.

I'm confident enough to speak up and encourage the team to stay on track. When I
notice things going off topic, I'll gently steer us back to the core format:
what I did, what I'm doing, blockers. I encourage parking deeper discussions for
afterwards, where interested people can stay. I model this by keeping my own
updates short.
...
where team members felt supported and could raise issues without fear.

I ran regular 1:1s with each team member to discuss career progression, work
through problems, and give them space to raise concerns. Held team meetings with
project updates, shoutouts, and knowledge sharing. Made myself available and
approachable.
...
about how to improve things. I make sure we come up with concrete action items
with delegated ownership, and that we revisit progress on these in subsequent
retros.
...
When delegating, it's tempting to prescribe exactly how something should be
done, especially when you already have an approach in mind.
